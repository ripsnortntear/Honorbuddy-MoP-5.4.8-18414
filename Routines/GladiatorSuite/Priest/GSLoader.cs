...
namespace Loader
{
    ...
    /// </summary>
    [UsedImplicitly]
    public class GladiatorSuitePriest : CombatRoutine
    {
        ...
        private static readonly string SDir = Path.Combine(Utilities.AssemblyDirectory,
            @"Routines\GladiatorSuite\Priest");

        private readonly string _dllPath = SDir + @"\GSPriest.dll";
        ...
        private bool ValidateInstallation()
        {
            try
            {
                ...
                MessageBox.Show(
                    ...
                    @"\honorbuddy\Routines\GladiatorSuite\Priest\n" +
                    "The Priest folder has to contain two files called GSLoader.cs and GSPriest.dll",
