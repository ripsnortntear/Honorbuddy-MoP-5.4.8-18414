...
namespace Loader
{
    ...
    /// </summary>
    [UsedImplicitly]
    public class GladiatorSuiteHunter : CombatRoutine
    {
        ...
        private static readonly string SDir = Path.Combine(Utilities.AssemblyDirectory,
            @"Routines\GladiatorSuite\Hunter");

        private readonly string _dllPath = SDir + @"\GSHunter.dll";
        ...
        private bool ValidateInstallation()
        {
            try
            {
                ...
                MessageBox.Show(
                    ...
                    @"\honorbuddy\Routines\GladiatorSuite\Hunter\n" +
                    "The Hunter folder has to contain two files called GSLoader.cs and GSHunter.dll",
