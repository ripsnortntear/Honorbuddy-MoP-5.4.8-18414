...
namespace Loader
{
    ...
    /// </summary>
    [UsedImplicitly]
    public class GladiatorSuiteMage : CombatRoutine
    {
        ...
        private static readonly string SDir = Path.Combine(Utilities.AssemblyDirectory,
            @"Routines\GladiatorSuite\Mage");

        private readonly string _dllPath = SDir + @"\GSMage.dll";
        ...
        private bool ValidateInstallation()
        {
            try
            {
                ...
                MessageBox.Show(
                    ...
                    @"\honorbuddy\Routines\GladiatorSuite\Mage\n" +
                    "The Mage folder has to contain two files called GSLoader.cs and GSMage.dll",
