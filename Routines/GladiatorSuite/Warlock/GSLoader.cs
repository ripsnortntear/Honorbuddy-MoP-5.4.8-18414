...
namespace Loader
{
    ...
    /// </summary>
    [UsedImplicitly]
    public class GladiatorSuiteWarlock : CombatRoutine
    {
        ...
        private static readonly string SDir = Path.Combine(Utilities.AssemblyDirectory,
            @"Routines\GladiatorSuite\Warlock");

        private readonly string _dllPath = SDir + @"\GSWarlock.dll";
        ...
        private bool ValidateInstallation()
        {
            try
            {
                ...
                MessageBox.Show(
                    ...
                    @"\honorbuddy\Routines\GladiatorSuite\Warlock\n" +
                    "The Warlock folder has to contain two files called GSLoader.cs and GSWarlock.dll",
