...
namespace RichieShadowPriestPvP
{
    public static class Extensions
    {
        ...
        {
            return unit != null && unit.HasAura((int)spellId);
        }
        ...
        {
            return u != null && u.IsValid && u.Attackable && u.IsAlive && !u.HasAura(SpellIDs.Cyclone);
        }
        ...
        public static bool IsEnemy(this WoWUnit target)
        {
            ...
            //return p.IsHorde != UnitManager.Me.IsHorde;
            return ((Main.IsArena || Main.IsRBG) && !p.IsInMyPartyOrRaid) || p.IsHorde != UnitManager.Me.IsHorde;
        ...
        public static bool MassDispelableInvulnerability(this WoWUnit target)
        {
            ...
            return target.HasAura(SpellIDs.IceBlock) || target.HasAura(SpellIDs.DivineShield)
                || target.HasAura(SpellIDs.HandOfProtection) || target.HasAura(SpellIDs.IceBlockSymbiosis);
        }
        ...
        public static bool DebuffCCleanseASAP(this WoWUnit target)
        {
            ...
            if (target.ActiveAuras.Any(a => SPSettings.DebuffCCPurifyASAPHS.Contains(a.Value.SpellId) && a.Value.TimeLeft.TotalMilliseconds > 3000))
                return true;
            return false;
        }
        ...
        /*public static bool NeedsInterrupt(this WoWUnit target)
        {
            ...
            return (SpellsToInterruptHS.Contains(target.CastingSpellId) && target.CurrentCastTimeLeft.TotalMilliseconds <= SPSettings.Instance.InterruptSpellCastsAfter) || SpellsToInterruptHS.Contains(target.ChanneledCastingSpellId);
        }*/
        ...
        public static bool HasdDebuffRootOrSnare(this WoWUnit target)
        {
        ...
        public static bool ShouldDispelBuffASAP(this WoWUnit target)
        {
            ...
            return target.ActiveAuras.Any(a => SPSettings.Instance.BuffDispelASAPHS.Contains(a.Value.SpellId));
        }
        ...
        public static bool IsInvulnerableSpell(this WoWUnit target)
        {
            if (target == null)
                return false;
        ...
        public static bool HasBreakOnDamageCC(this WoWUnit target) {
