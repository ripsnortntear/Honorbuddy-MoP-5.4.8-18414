...
namespace RichieShadowPriestPvP
{
    public static class CombatLog
    {
        ...
        public static System.Action<SpellIDs, LuaEventArgs> OnSpellEnergize;
        ...
        private static void HandleCombatLog(object sender, LuaEventArgs args)
        {
            ...
            switch (args.Args[1].ToString())
            {
                ...
                /*case "SPELL_AURA_APPLIED":
                    ...
                    for (int i = 0; i < args.Args.Length; i++) {
                        Logging.Write("args[" + i + "] = " + args.Args[i]);
                    }
                    break;*/

                case "SPELL_ENERGIZE":
                    if (OnSpellEnergize != null)
                        OnSpellEnergize(id, args);
                    break;
            ...
            SPCoolDown.ConfirmSpellCast(id);
        }
    }
}