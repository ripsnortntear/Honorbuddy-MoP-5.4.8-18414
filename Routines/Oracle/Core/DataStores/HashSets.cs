 ...
 * $ID$
 * $Revision: 212 $
 * $URL: https://subversion.assembla.com/svn/oracle/trunk/Oracle/Core/DataStores/HashSets.cs $
 * $LastChangedBy: wulf_ $
 * $ChangesMade$
 */
...
namespace Oracle.Core.DataStores
{
    internal static class HashSets
    {
        ...
        public static HashSet<int> TankDebuffs = new HashSet<int>
            {
                0000, // Some debuff
            };
        ...
        public static readonly HashSet<int> GiftoftheTitansBuff = new HashSet<int>
            {
                146595,
                146594,
                144359,
        ...
        public static readonly HashSet<int> HealableNPCs = new HashSet<int>
            {
                72218, //Oto the Protector
                72219, // Ki the Assassin
                72221, // Kavan the Arcanist
                72220, // Sooli the Survivalist
                71604, // the oozes on immerseus
                72000, // sun tenderheart
                71996, // rook
                71995, //  is leven
                //62445, //Ji Firepaw in Org (testing)
            };

        public static readonly HashSet<int> InvalidNPCs = new HashSet<int>
            {
                69340,
                69456,
            };

        public static readonly HashSet<int> IgnoreCanCast = new HashSet<int>
            {
                106731, //Incarnation
            };

        // Thanks to Millz
        public static readonly HashSet<string> DoNotDamageList = new HashSet<string>
        {
            ...
            "Blind",// (Rogue)
            "Gouge",// (Rogue)
            "Paralysis",// (Paralytic Poison - Rogue)
            "Sap",// (Rogue)
            "Smoke Bomb",// (Rogue)
            ...
            "Banish",// (Warlock)
            "Mesmerize",// (Shivarra - Warlock Pet)
            "Sleep",// (Metamorphosis - Warlock)

            "Freezing Trap",// (Hunter)
            "Paralyzing Quill",// (Porcupine - Hunter Pet)
            "Petrifying Gaze",// (Basilisk - Hunter Pet)
            "Scare Beast",// (Hunter)
            "Scatter Shot",// (Hunter)
            "Wyvern Sting",// (Hunter)
            "Deterrence",// (Hunter - Spell Reflect)

            "Spell Reflection",// (Warrior)
            "Mass Spell Reflection",// (Warrior)
        };
        ...
        #endregion Category : PvP Migigate Stun
        ...
        #endregion Category : PvP ccthatcanbreak
        ...
        #endregion Category : PvP Polymorph
        ...
        #endregion Category : PvP DMG Reflect
        ...
        #region Category : PvP DispellableEnrages

        internal static readonly HashSet<int> PvPDispellableEnrages = new HashSet<int> {
            //Death Knight
        ...
        #endregion Category : PvP DispellableEnrages
        ...
        #endregion Category : PvP StealthAuras
    }
}