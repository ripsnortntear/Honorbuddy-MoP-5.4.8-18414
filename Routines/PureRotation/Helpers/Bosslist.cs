...
/*
 * $Author: nomnomnom $
 * $Date: 2013-09-10 22:54:33 +0200 (Di, 10 Sep 2013) $
 * $ID$
 * $Revision: 1722 $
 * $URL: https://subversion.assembla.com/svn/purerotation/trunk/PureRotation/Helpers/Bosslist.cs $
...
namespace PureRotation.Helpers
{
    public static class BossList
    {
        ...
        public static void Init()
        {
            ...
            {
                Logger.DebugLog("- boss {0}", s);
            }
            Logger.DebugLog("BossList: contains {0} entries", CurrentMapBosses.Count());
        }

        #region Ignore Shadow Dance for These Bosses
        ...
        #endregion Ignore Shadow Dance for These Bosses

        #region OverrideDnD for These Bosses
        ...
        #endregion OverrideDnD for These Bosses
        ...
        #endregion Ignore AoE for These Bosses

        #region Ignore Backstab for These Bosses
        ...
        #endregion Ignore Backstab for These Bosses

        #region Ignore Shred for These Bosses
        ...
        #endregion Ignore Shred for These Bosses
        ...
        #endregion Ignoring Range checks for these bosses as blizzard loves to fuck with us botters.
