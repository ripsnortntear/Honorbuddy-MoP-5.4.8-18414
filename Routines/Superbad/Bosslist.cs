...
namespace Superbad
{
    public static class BossList
    {
        static BossList()
        {
            foreach (uint bossId in _dummies)
            {
                _bosses.Add(bossId);
            }
        }
        ...
        private static readonly HashSet<uint> _avoidRear = new HashSet<uint>
        {
            ...
            63191,
            // Garalon in Heart of Fear This boss is riding an invisible vehicle and facing is relative to vehicle's facing.
            69465, // Jin'rokh the Breaker in Throne of Thunder
            68476, // Horridon in Throne of Thunder
            43214, // Slabhide in The Stonecore
        };

        public static HashSet<uint> AvoidRearBosses
        {
            get { return _avoidRear; }
        }
