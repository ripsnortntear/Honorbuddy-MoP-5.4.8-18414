...
namespace MageHelper
{
    public partial class UI : Form
    {
        ...
        private void MHelperConfig_Load(object sender, EventArgs e)
        {
            ...
            cbBlinkKill.Checked = MageHelperSettings.Instance.UseBlinkKillPOI;
            useslowfall.Checked = MageHelperSettings.Instance.UseSlowFall;
            useinvis.Checked = MageHelperSettings.Instance.UseInvis;
            cbIceBarrier.Checked = MageHelperSettings.Instance.AlwaysHaveIceBarrier;
        ...
        private void cbBlinkKill_CheckedChanged(object sender, EventArgs e)
        {
            MageHelperSettings.Instance.UseBlinkKillPOI = cbBlinkKill.Checked;
        }

        private void cbIceBarrier_CheckedChanged(object sender, EventArgs e)
        {
            MageHelperSettings.Instance.AlwaysHaveIceBarrier = cbIceBarrier.Checked;
        }
